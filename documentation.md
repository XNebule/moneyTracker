...
## _GOAL: Understanding [server, routes, controllers, services, databases]_
...
**Flow of request:**
**_Client -> Express(server) -> Pgsql(Database) -> Back to Express(server) -> Response to client Requests_**

# Feb, 28 2026 - Day 2 - Status: Completed

## _GOAL: Implement [Update, Delete] on routes architecture, Implement users' Credential registration and login_
